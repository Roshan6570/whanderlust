...
// });
  ...
  //     email:"patilroshan6570@gmail.com",
  //     username:"patilroshan",
  //   });
  //    let newuserRegister=await User.register(fakeuser,"patil@4050");
  //    res.send(newuserRegister);
  //  });
...
app.use("/",userRouter);
  ...
  app.use((err, req, res, next)=>{
    let {statusCode=500,message="sommthing went wrong!"} = err;
